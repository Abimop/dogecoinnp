...
// Copyright (c) 2026-2028 The Termubit developers
...
public:
    CMainParams() {
        ...
        consensus.powLimit = uint256S("0x000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20;
